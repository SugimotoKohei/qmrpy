...
- **Models**: T1 (VFA, IR, DESPOT1-HIFI, T1MP2RAGE), T1rho, MTR/MTsat, T2/T2* (mono-exp, EPG, EMC, R2*), B0/B1, QSM, denoising
...
- **モデル**: T1（VFA, IR, DESPOT1-HIFI, T1MP2RAGE）、T1rho、MTR/MTsat、T2/T2*（単指数、EPG、EMC、R2*）、B0/B1、QSM、ノイズ除去
